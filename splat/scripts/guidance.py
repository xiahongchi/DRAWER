...
guidance_config = {
    ...
    'diffusion_type': 'd2i_controlnet', # t2i / d2i / d2i_controlnet
    ...
    'latent_size': 64, # DO NOT CHANGE unless you know what you're doing!!!
    ...
    'render_size': 512, # DO NOT CHANGE unless you know what you're doing!!!
    'decode_size': 512, # DO NOT CHANGE unless you know what you're doing!!!
    ...
    "log_dir": "", # TODO
    'prompt': "the view of a wooden drawer's interior in the room", # TODO
    'a_prompt': 'best quality, high quality, extremely detailed, good geometry, high-res photo',
    "n_prompt": 'deformed, extra digit, fewer digits, cropped, worst quality, low quality, smoke, shading, lighting, lumination, shadow, text in image, watermarks, mismatched, inconsistent, spotted, chaotic',
...
guidance_config = AttrDict(guidance_config)
...
class Guidance(nn.Module):
    ...
    def _init_backbone(self):
        if self.config.diffusion_type == "t2i":
            ...
            if self.config.inpaint:
                checkpoint_name = "runwayml/stable-diffusion-inpainting"
            else:
                checkpoint_name = "runwayml/stable-diffusion-v1-5"
    ...
    def predict_noise_mask_inpaint(self, unet, noisy_latents, t, mask, masked_image_latents, cross_attention_kwargs, guidance_scale, control=None):
        down_block_res_samples, mid_block_res_sample = None, None
        ...
        if guidance_scale == 1:
            ...
            # if self.config.verbose_mode: start = time.time()
            latent_model_input = latent_model_input.to(self.weights_dtype)
            mask = mask.to(self.weights_dtype)
    ...
    def compute_sds_loss_mask_inpaint(self, latents, noisy_latents, noise, t, mask, masked_image_latents, control=None):
        with torch.no_grad():
            noise_pred = self.predict_noise_mask_inpaint(
                self.unet,
                noisy_latents,
                t,
                mask,
