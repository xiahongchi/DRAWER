...
from nerfstudio.models.splatfacto_on_mesh import SplatfactoOnMeshModelConfig
from nerfstudio.models.splatfacto_on_mesh_dup import SplatfactoOnMeshDupModelConfig
from nerfstudio.models.splatfacto_on_mesh_uc import SplatfactoOnMeshUCModelConfig
...
descriptions = {
    ...
    "splatfacto_on_mesh": "Gaussian Splatting model on Mesh",
    "splatfacto_on_mesh_dup": "Gaussian Splatting model on Mesh and faces could have multiple gaussians",
}
...
method_configs["splatfacto_on_mesh"] = TrainerConfig(
    method_name="splatfacto_on_mesh",
    steps_per_eval_image=100,
    steps_per_eval_batch=0,
    steps_per_save=2000,
    steps_per_eval_all_images=1000,
    ...
    pipeline=VanillaPipelineConfig(
        ...
        model=SplatfactoOnMeshModelConfig(),
    ),
    optimizers={
        "bary_coords": {
            "optimizer": AdamOptimizerConfig(lr=1.6e-4, eps=1e-15),
        ...
        "quats": {"optimizer": AdamOptimizerConfig(lr=0.001, eps=1e-15), "scheduler": None},
        "camera_opt": {
            "optimizer": AdamOptimizerConfig(lr=1e-30, eps=1e-15),
            "scheduler": ExponentialDecaySchedulerConfig(
...
method_configs["splatfacto_on_mesh_dup"] = TrainerConfig(
    method_name="splatfacto_on_mesh_dup",
    steps_per_eval_image=100,
    steps_per_eval_batch=0,
    steps_per_save=2000,
    steps_per_eval_all_images=1000,
    ...
    pipeline=VanillaPipelineConfig(
        ...
        model=SplatfactoOnMeshDupModelConfig(),
    ),
    optimizers={
        "bary_coords": {
            "optimizer": AdamOptimizerConfig(lr=1.6e-4, eps=1e-15),
...
method_configs["splatfacto_on_mesh_uc"] = TrainerConfig(
    method_name="splatfacto_on_mesh_uc",
    steps_per_eval_image=100,
    steps_per_eval_batch=0,
    steps_per_save=2000,
    steps_per_eval_all_images=1000,
    ...
    pipeline=VanillaPipelineConfig(
        ...
        model=SplatfactoOnMeshUCModelConfig(),
    ),
    optimizers={
        "means_2d": {
            "optimizer": AdamOptimizerConfig(lr=1.6e-4, eps=1e-15),
...
method_configs["splatfacto_on_mesh_uc_longer"] = TrainerConfig(
    method_name="splatfacto_on_mesh_uc_longer",
    steps_per_eval_image=100,
    steps_per_eval_batch=0,
    steps_per_save=2000,
    steps_per_eval_all_images=1000,
