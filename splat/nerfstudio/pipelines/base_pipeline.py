...
class VanillaPipeline(Pipeline):
    ...
    def __init__(
        ...
        if (
                hasattr(self.datamanager, "train_dataparser_outputs")
                and "means" in self.datamanager.train_dataparser_outputs.metadata
        ):
            seed_mesh = {
                "means": self.datamanager.train_dataparser_outputs.metadata["means"],
                "radius": self.datamanager.train_dataparser_outputs.metadata["radius"],
                "features_dc": self.datamanager.train_dataparser_outputs.metadata["features_dc"],
                "normals": self.datamanager.train_dataparser_outputs.metadata["normals"],
                "mesh_verts": self.datamanager.train_dataparser_outputs.metadata["mesh_verts"],
                "mesh_faces": self.datamanager.train_dataparser_outputs.metadata["mesh_faces"],
                "mesh_dir": self.datamanager.train_dataparser_outputs.metadata["mesh_dir"],
            }
