...
class Cameras(TensorDataclass):
    ...
    projections: TensorType["num_cameras":..., 4, 4]
    camprojs: TensorType["num_cameras":..., 4, 4]
    ...
    def __init__(
        ...
        projections: TensorType["num_cameras":..., 4, 4] = None,
        camprojs: TensorType["num_cameras":..., 4, 4] = None,
    ):
        ...
        self._field_custom_dimensions = {"camera_to_worlds": 2, "projections": 2, "camprojs": 2}

        self.camera_to_worlds = camera_to_worlds
        self.projections = projections
        self.camprojs = camprojs
